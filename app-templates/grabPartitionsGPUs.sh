...
PATH="/uufs/redwood.bridges/sys/installdir/slurm/std/bin:$PATH"

# File to store the output
OUTPUT_FILE="/uufs/chpc.utah.edu/sys/ondemand/chpc-pe-apps/app-templates/gpus.txt"

# File containing the list of clusters
CLUSTER_FILE="/uufs/chpc.utah.edu/sys/ondemand/chpc-pe-apps/app-templates/cluster.txt"
