...
OUTPUT_FILE="/uufs/chpc.utah.edu/sys/ondemand/chpc-pe-apps-v3.4/app-templates/gpus_ew.txt"

# File containing the list of clusters
CLUSTER_FILE="/uufs/chpc.utah.edu/sys/ondemand/chpc-pe-apps-v3.4/app-templates/cluster_ew.txt"
